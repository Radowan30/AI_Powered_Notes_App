...
class NoteController extends Controller
{
    ...
    {
        $summary_obj = app(SummaryController::class);

        $summary_json = $summary_obj($request);

        $summary_array = json_decode($summary_json, true);

        $data = $request->validate(['note' => ['required', 'string']]); //validates if the note data in the request is a required and string or not, and then it returns something which gets stored in the data variable

        $data['note_summary'] = (string) $summary_array['title']; //adding the title generated by the AI to the 'note_summary' key as a value in the $data array
